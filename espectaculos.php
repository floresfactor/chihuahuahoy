...
$resDep = $crud->selectDesc("clasificacion","espectaculos","3");

?>
<div class="block">
	<h2 class="list-title" >Espectaculos</h2>
	<ul class="article-block">
		<li>
			<div class="article-photo">
				<a href="<?php echo'post.php?id='.$resDep['0']['id'].'' ?>" ><img src="imagesnotas/<?php echo $resDep['0']['imagen'];  ?>" width="250" height="125" /></a>
			</div>
		...
		<li>
			<div class="article-photo">
				<a href="<?php echo'post.php?id='.$resDep['1']['id'].'' ?>" ><img src="imagesnotas/<?php echo $resDep['1']['imagen'];  ?>" width="250" height="125" /></a>
			</div>
			<div class="article-content">
