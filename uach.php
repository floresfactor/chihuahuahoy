...
$resGob = $crud->selectDesc("clasificacion","Uach","2");

?>
<div class="block">
	<h2 class="list-title" >UACH</h2>
	<ul class="article-block">
		...
		<li>
        	...
        	<li>
			<div class="article-photo">
				<a href="<?php echo'post.php?id='.$resGob['2']['id'].'' ?>" class="hover-effect"><img src="imagesnotas/<?php echo $resGob['2']['imagen'];  ?>" width="250" height="125" /></a>
			</div>
			<div class="article-content">
				<h4><a href="<?php echo'post.php?id='.$resGob['2']['id'].'' ?>"><?php echo $resGob['2']['titulo'];  ?></a></h4>
				<span class="meta">
				<!--	<a href="blog.html"><span class="icon-text">&#128340;</span>11:20, 7.Oct 2013</a>-->
				</span>
			</div>
