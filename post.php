				...
				<div class="double-block">
						...
						<div class="block">
							<div class="block-content">
								...
								<div class="shortcode-content">
												...
												{
													echo '<p align="justify">'.$resPost['0']['parrafo'].'</p><br>';
												}
												else
												{
													echo '<p align="justify">'.$resPost['0']['parrafo'].'</p>';
												...
												{
													echo '<p align="justify">'.$resPost['0']['parrafo2'].'</p><br>';
												}
												else
												{
													echo '<p align="justify">'.$resPost['0']['parrafo2'].'</p>';
													echo '<p align="justify">'.$resPost['0']['imagen3'].'</p><br>';
												}
												
												if ($resPost['0']['imagen4']=='') 
												{
													echo '<p align="justify">'.$resPost['0']['parrafo3'].'</p><br>';
												}
												else
												{
													echo '<p align="justify">'.$resPost['0']['parrafo3'].'</p>';
													echo '<p align="justify">'.$resPost['0']['imagen4'].'</p><br>';
												}

												if ($resPost['0']['imagen5']=='') 
												{
													echo '<p align="justify">'.$resPost['0']['parrafo4'].'</p><br>';
												}
												else
												{
													echo '<p align="justify">'.$resPost['0']['parrafo4'].'</p>';
													echo '<p align="justify">'.$resPost['0']['imagen5'].'</p><br>';
												}

												echo '<p align="justify">'.$resPost['0']['parrafo5'].'</p>';
					...
					<div class="main-sidebar right">
						...
						<div class="widget">
								...
								<!-- END .widget -->
								<!--<a href="http://www.chihuahua.gob.mx" ><img src="images/jazz300.jpg" alt="Festival de Jazz Chihuahua Juarez" /></a>-->
